...
export const projects: ProjectData[] = [
  ...
  },
  {
    ...
    name: '香菜 UI',
    description:
      '一款基于 Vue3 / TypeScript / Webpack 的 UI 框架组件库，并基于 Vite / Vue-Router 搭建了本组件库官网',
    icon: '/coriander.png',
  ...
  },
  {
    ...
    name: '咔咔图床',
    description:
      '一款基于 React / React-Router / Mobx / LeanCloud / Antd 的图床',
    icon: '/kaka.png',
  ...
  },
  {
    ...
    name: '葡萄记账',
    description:
      '一款基于 React / React-Router / React Hooks / TypeScript / SVG 的移动端多页面应用',
    icon: '/grape.png',
  ...
  },
  {
    ...
    name: '甜仔钱袋',
    description:
      '一款基于 Vue2 / Vue-Router / TypeScript / webpack 的移动端多页面记账应用',
    icon: '/money.png',
  ...
  },
  {
    key: 'terse-todo',
    name: '简洁清单',
    description: '一款基于 Node.js / Commander.js 的极简命令行任务工具',
    icon: '/todo.png',
  ...
  },
  {
    ...
    name: '简洁翻译',
    description:
      '一款基于 Node.js / TypeScript / Commander.js / 百度翻译API 的终端翻译工具',
    icon: '/translate.png',
